<template>
  <div class="page-view">
    <h1 class="page-title">Cours de Seconde</h1>
    <p class="page-intro">Les bases fondamentales du lycée en Mathématiques et Physique-Chimie.</p>
...
const modulesTerminale = ref(getModulesByLevel('Seconde'))
