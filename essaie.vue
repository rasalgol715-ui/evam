...
<template>
  <div class="home-view">
    <!-- Nouveau fond quantique amélioré -->
    <QuantumBackground />
    ...
    <section class="hero-section-dark">
      <div class="hero-content">
        <div class="title-container">
          <h1>Bienvenue chez EvaM Group</h1>
        </div>
        <p class="hero-subheadline">L'excellence éducative réinventée</p>
        <p class="hero-description">
          Plateforme leader d'apprentissage en ligne au Sénégal
        </p>
...
const listeFascicules = ref([
  {
    ...
    previewHtml: '<h4>Chapitre 1 : Les Limites et la Continuité</h4><p>Découvrez les concepts fondamentaux des limites et de la continuité des fonctions avec des exemples concrets et des exercices progressifs.</p>'
  },
  {
    id: 'pc_tle',
    nom: 'PC Terminale',
    ...
    previewHtml: '<h4>Chapitre 1 : La Mécanique Newtonienne</h4><p>Étudiez les lois de Newton et leurs applications dans des situations réelles avec des démonstrations détaillées.</p>'
  },
  {
    id: 'math_1ere',
    nom: 'Maths Première',
    ...
    previewHtml: '<h4>Chapitre 1 : Le Second Degré</h4><p>Maîtrisez les fonctions polynômes du second degré, leurs propriétés et leurs représentations graphiques.</p>'
  },
  {
    id: 'math_2nde',
    nom: 'Maths Seconde',
    prix: 4000,
    coverImg: '/images/pc_tle_cover.png',
    previewHtml: '<h4>Chapitre 1 : Les Ensembles de Nombres</h4><p>Introduction aux différents ensembles numériques et à leurs propriétés fondamentales.</p>'
  },
])
...
/* Le reste de votre CSS existant pour les autres sections */
...
/* Ajustements pour l'animation de fond */
section {
  position: relative;
  z-index: 1;
}
